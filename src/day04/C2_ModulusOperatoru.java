...
public class C2_ModulusOperatoru {
	...
	public static void main(String[] args) {
      // modulus operatoru bolme isleminde kalani verir
		...
		// 25 uce bolunur mu ? 24/3 kalan=1
		...
		// 856 sayisinin birler basamaðý kactir ? 6
		int sayi=856;
		...
		// bunun icin buldugumbirler basamaginden kurtmam gerekiyor
		//birler basamaginden kurtulmak icin ise sayiyi 10'a boluyorum
	  sayi/=10; //85
	  ...
	  //yuzler basamagini blmak icin bir kere daha ayni islemi yapiyorum
	  sayi/=10; // bu satirla onlar basamagindan da kurtuluyorum
	  System.out.println("2.defa 10'a bolduktan sonra " + sayi);
