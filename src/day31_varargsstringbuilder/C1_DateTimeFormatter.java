...
LocalDateTime ldt = LocalDateTime.now();System.out.println(ldt); // 2021-03-20T17:14:59.148

	DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yy/MMMM/dd hh:mm");
	/*
	 * yy : yilin son iki rakamini
	 *  yyyy: yilin tamamini
	 *   M: ay sirasini verir marticin : 3 
	...
	DateTimeFormatter dtf2 = DateTimeFormatter.ofPattern("yy/MMM/dd");System.out.println(dtf2.format(ldt)); // 21/Mar/20
	...
	int yas=Period.between(dogumTarihi, bugun).getYears();System.out.println(yas);
