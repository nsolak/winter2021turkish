...
public class C4_Varargs03 {
	...
	public static void main(String[] args) {
		//verilen int'lardan ilki haric tum sayilari toplayinve
	...
	public static void toplama(int sayi1, int... var) { // data turunden sonra yazdigimiz...
		// varags kullanacagýmiz anlamina gelir
