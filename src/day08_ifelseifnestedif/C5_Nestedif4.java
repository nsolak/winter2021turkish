...
public class C5_Nestedif4 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// 1.islem kullanciden sifreyi alipilk harfine bak
		//buyk harfmi yoksa kucukharf mi?
		
		Scanner scan=new Scanner (System.in);
		 System.out.println("Lutfen sifrenizi giriniz");
		  
		 char ilkHarf = scan.next().charAt(0); // gieilen sifrenin ilk karakterini alir
		...
		}else if(ilkHarf>='a' && ilkHarf<='z') { // ilk harf  kucukise
			if(ilkHarf=='z') {
		       System.out.println("sifre gecerli");
			}else {
